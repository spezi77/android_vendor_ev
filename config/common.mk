...
ifeq ($(NIGHTLY_BUILD),true)
  ...
  ROM_VERSION := $(TARGET_PRODUCT)-UNOFFICIAL-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_EXTRA)-$(PRODUCT_CODENAME)$(APPEND_ZIP)
endif
